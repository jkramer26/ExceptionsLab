...
public class Employee {
    ...
    //a class should be open to addition closed to change
    //concrete methods should be final
    ...
    //final means method can't be changed, but variable still can 
    ...
    public final void setSsn(String ssn) {
        ...
        ssn = ssn.replaceAll("-", "");
        //could also do this ssn.replaceAll("\\D", "");
        //the above says to remove anything that is not a digit
